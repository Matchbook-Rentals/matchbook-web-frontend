...
const FurnishedSelect: React.FC<FurnishedSelectProps> = ({ goToNext, goToPrev, setUserPreferences }) => {
  ...
  return (
    <>
      ...
      <div className='card border border-black flex flex-col w-1/2 mx-auto mt-5 rounded-2xl p-5'>
        {/* <CheckedRadio /> */}
        <CheckboxDemo key='furnished' justifyDirection='between' label='Furnished' isChecked={isFurnished === 'Furnished'} details={{ id: 'Furnished' }} handleChange={setIsFurnished} hasBorder />
        <CheckboxDemo key='unfurnished' justifyDirection='between' label='Unfurnished' isChecked={isFurnished === 'Unfurnished'} details={{ id: 'Unfurnished' }} handleChange={setIsFurnished} />
      </div>
