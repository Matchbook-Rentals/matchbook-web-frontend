...
import { createRenterReview, getExistingRenterReview } from "./_actions";
...
export default function RenterReviewPage({ params }: ReviewPageProps) {
  ...
  useEffect(() => {
    const loadExistingReview = async () => {
      const result = await getExistingRenterReview(params.bookingId);
  ...
  const handleSubmit = async () => {
    ...
    if (result.success) {
      router.push(`/app/rent/bookings/${params.bookingId}`);
    } else {
