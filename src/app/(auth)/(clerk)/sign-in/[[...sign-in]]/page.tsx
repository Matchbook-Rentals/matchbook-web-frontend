  ...
  return (
    <div className="flex flex-col md:flex-row w-full mx-auto max-h-[100vh]">
      ...
      <div className="hidden md:block w-0 lg:w-1/2">
        <img className="object-cover w-full h-screen" src="/vertical-shot-golden-gate-bridge-against-misty-blue-sky-san-francisco-california-usa.jpg" alt="Matchbook sign in" />
      </div>
    </div>
  )
}
