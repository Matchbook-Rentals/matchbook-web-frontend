...
import ListingImageCarousel from '@/app/platform/trips/(trips-components)/image-carousel';
import { ListingAndImages } from '@/types';
import ListingDescription from '@/app/platform/trips/(trips-components)/listing-info';
      ...
      <div className="w-full mx-auto pb-[100px] md:pb-[160px] lg:pb-6">
        ...
        <div className="pb-3 mt-3" ref={locationSectionRef}>
          ...
          <div className="pb-3 text-[#404040] text-[20px] font-normal">
            <p>
              {listing.category} in {listing.locationString}
            </p>
          </div>
