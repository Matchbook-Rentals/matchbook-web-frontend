...
const BedTypeSelect: React.FC<BedTypeSelectProps> = ({
  bedroomIndex,
  selectedBedType,
  setSelectedBedType,
}) => {
  ...
  return (
    <div className="flex items-center gap-4 mb-3">
      <Label htmlFor={bedroomId}>Bedroom {bedroomIndex}</Label>{" "}
      {/* Dynamically label based on bedroom index */}
      <Select value={selectedBedType} onValueChange={handleChange}>
        ...
        <SelectContent>
          <SelectGroup>
            ...
            <SelectItem className="cursor-pointer" value="twin">
              Twin
            </SelectItem>
            <SelectItem className="cursor-pointer" value="twinxl">
              Twin XL
            </SelectItem>
            <SelectItem className="cursor-pointer" value="full">
              Full
            </SelectItem>
            <SelectItem className="cursor-pointer" value="queen">
              Queen
            </SelectItem>
            <SelectItem className="cursor-pointer" value="king">
              King
            </SelectItem>
            <SelectItem className="cursor-pointer" value="caking">
              California King
            </SelectItem>
            <SelectItem className="cursor-pointer" value="bunk">
              Bunk Bed
            </SelectItem>
