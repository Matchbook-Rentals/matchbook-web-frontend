...
const PropertyAmenitySelect: React.FC<PropertyAmenitySelectProps> = ({
  ...
  const amenitiesOptions = [
    {
      ...
      isRequired: propertyDetails.airConditioning,
    },
    {
      id: "fitnessCenter",
      label: "Fitness Center",
      isRequired: propertyDetails.fitnessCenter,
    },
    {
      id: "dishwasher",
      label: "Dishwasher",
      isRequired: propertyDetails.dishwasher,
    },
    ...
    { id: "elevator", label: "Elevator", isRequired: propertyDetails.elevator },
    {
      ...
      isRequired: propertyDetails.wheelchairAccess,
    },
    { id: "doorman", label: "Doorman", isRequired: propertyDetails.doorman },
    {
      id: "fireplace",
      label: "Fireplace",
      isRequired: propertyDetails.fireplace,
    },
    ...
    { id: "kitchen", label: "Kitchen", isRequired: propertyDetails.kitchen },
    {
      ...
      isRequired: propertyDetails.dedicatedWorkspace,
    },
    { id: "tv", label: "TV", isRequired: propertyDetails.tv },
    {
      id: "hairDryer",
      label: "Hair Dryer",
      isRequired: propertyDetails.hairDryer,
    },
    ...
    { id: "gym", label: "Gym", isRequired: propertyDetails.gym },
    {
      ...
      isRequired: propertyDetails.smokingAllowed,
    },
    {
      id: "eventsAllowed",
      label: "Events Allowed",
      isRequired: propertyDetails.eventsAllowed,
    },
    {
      id: "privateEntrance",
      label: "Private Entrance",
      isRequired: propertyDetails.privateEntrance,
    },
    { id: "secure", label: "Secure", isRequired: propertyDetails.secure },
    {
      id: "waterfront",
      label: "Waterfront",
      isRequired: propertyDetails.waterfront,
    },
    {
      id: "beachfront",
      label: "Beachfront",
      isRequired: propertyDetails.beachfront,
    },
    {
      id: "mountainView",
      label: "Mountain View",
      isRequired: propertyDetails.mountainView,
    },
  ];
  ...
  const structuralOptions = [
    ...
    {
      id: "wheelAccessible",
      label: "Wheel Accessible",
      isRequired: propertyDetails.wheelAccessible,
    },
    {
      id: "fencedInYard",
      label: "Fenced in yard",
      isRequired: propertyDetails.fencedInYard,
    },
    { id: "doorman", label: "Doorman", isRequired: propertyDetails.doorman },
    {
      id: "secureLobby",
      label: "Secure lobby",
      isRequired: propertyDetails.secureLobby,
    },
    {
      id: "keylessEntry",
      label: "Keyless entry",
      isRequired: propertyDetails.keylessEntry,
    },
    {
      id: "alarmSystem",
      label: "Alarm system",
      isRequired: propertyDetails.alarmSystem,
    },
    {
      id: "storageShed",
      label: "Storage Shed",
      isRequired: propertyDetails.storageShed,
    },
    {
      id: "airConditioning",
      label: "Air conditioning",
    ...
    { id: "heating", label: "Heating", isRequired: propertyDetails.heating },
    {
      id: "evCharging",
      label: "EV Charging",
      isRequired: propertyDetails.evCharging,
    },
  ];
  ...
  const kitchenOptions = [
    { id: "kitchen", label: "Kitchen", isRequired: propertyDetails.kitchen },
    {
      ...
      isRequired: propertyDetails.garbageDisposal,
    },
    {
      id: "dishwasher",
      label: "Dishwasher",
  ...
  const furnishedOptions = [
    { id: "tv", label: "TV", isRequired: propertyDetails.tv },
    {
      id: "workstation",
      label: "Workstation",
      isRequired: propertyDetails.workstation,
    },
    {
      id: "microwave",
      label: "Microwave",
      isRequired: propertyDetails.microwave,
    },
    {
      id: "kitchenEssentails",
      label: "Kitchen essentails",
      isRequired: propertyDetails.kitchenEssentails,
    },
  ...
  let generalAmenities = [
    ...
    { id: "gym", label: "Gym", isRequired: propertyDetails.gym },
    {
      ...
      isRequired: propertyDetails.privateBathroom,
    },
    { id: "wifi", label: "Wifi", isRequired: propertyDetails.wifi },
  ...
  const setWasherDetails: Dispatch<SetStateAction<string>> = (
    washerType: string,
  ) => {
  ...
  const setDryerDetails: Dispatch<SetStateAction<string>> = (
    dryerType: string,
  ) => {
    setPropertyDetails((prev) => ({
      ...prev,
    ...
    <>
      ...
      <div className="flex w-4/5 mb-2  mx-auto justify-evenly">
        <CheckboxDemo
          ...
          handleChange={() =>
            setPropertyDetails((prev) => ({
              ...prev,
              allowDogs: !prev.allowDogs,
            }))
          }
          isChecked={propertyDetails.allowDogs}
          details={{
            id: "dogs",
            label: "dogs",
            isRequired: propertyDetails.allowDogs,
          }}
        />
        <CheckboxDemo
          label="Cats Allowed"
          ...
          handleChange={() =>
            setPropertyDetails((prev) => ({
              ...prev,
              allowCats: !prev.allowCats,
            }))
          }
          details={{
            id: "cats",
            label: "cats",
            isRequired: propertyDetails.allowCats,
          }}
        />
      </div>
      ...
      <div className="flex justify-evenly mb-5 lg:w-3/4 mx-auto">
        <BrandRadio
          ...
          setSelectedValue={setWasherDetails}
          selectedValue={
            propertyDetails.washerInUnit
              ? "washerInUnit"
              : propertyDetails.washerHookup
                ? "washerHookup"
                : propertyDetails.washerNotAvailable
                  ? "washerNotAvailable"
                  : propertyDetails.washerInComplex
                    ? "washerInComplex"
                    : ""
          }
          radioLabel="Washer"
        ...
        <BrandRadio
          ...
          circleOnLeft
          setSelectedValue={setDryerDetails}
          selectedValue={
            propertyDetails.dryerInUnit
              ? "dryerInUnit"
              : propertyDetails.dryerHookup
                ? "dryerHookup"
                : propertyDetails.dryerNotAvailable
                  ? "dryerNotAvailable"
                  : propertyDetails.dryerInComplex
                    ? "dryerInComplex"
                    : ""
          }
          radioLabel="Dryer"
      ...
      <div className="flex w-4/5 mb-2  mx-auto justify-evenly">
        ...
        <div className="flex-col">
          <h4 className="text-center text-xl font-semibold border-b-2">
            Free?
          </h4>
