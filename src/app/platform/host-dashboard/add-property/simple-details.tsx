...
export default function SimpleDetails({
  ...
  const [bedTypes, setBedTypes] = useState<Array<string>>(
    Array(propertyDetails.roomCount).fill(""),
  );
  ...
  const handleNext = () => {
    const newErrors = {
      roomCount:
        propertyDetails.roomCount === null ||
        propertyDetails.roomCount === undefined,
      bathroomCount:
        propertyDetails.bathroomCount === null ||
        propertyDetails.bathroomCount === undefined,
      squareFootage:
        propertyDetails.squareFootage === null ||
        propertyDetails.squareFootage === undefined,
        ...
        <div className="flex flex-col gap-2">
          <div className="flex flex-col items-center">
            ...
            <Input
              ...
              value={
                propertyDetails.title !== undefined ? propertyDetails.title : ""
              }
            ...
            {errors.title && (
              <p className="text-red-500 mt-1">
                Please enter a valid listing title.
              </p>
            )}
          </div>
          <div
            id="property-address-container"
          ...
          >
            <div className="w-full max-w-lg flex flex-col justify-center p-4">
              <Label htmlFor="property-address" className="text-center">
                Property Address
              </Label>
          ...
          {numberFields.map((input) => (
            <div key={input.field} className="flex flex-col items-center">
              ...
              <Input
                ...
                value={
                  propertyDetails[input.field] !== undefined
                    ? propertyDetails[input.field]
                    : ""
                }
                onChange={(e) =>
                  handleChange(e, input.field as keyof Listing, input.inputType)
                }
                className="w-full max-w-xs"
              />
              {errors[input.field] && (
                <p className="text-red-500 mt-1">
                  Please enter a valid {input.placeholder.toLowerCase()}.
                </p>
              )}
            </div>
          ))}
