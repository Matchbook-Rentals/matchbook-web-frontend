...
const housingOptions = [
  {
    id: "single_family",
    label: "Single Family",
    src: "/img/listing-type/Single Family.png",
  },
  {
    id: "townhouse",
    label: "Townhouse",
    src: "/img/listing-type/Townhouse.png",
  },
  {
    id: "apartment",
    label: "Apartment",
    src: "/img/listing-type/Apartment.png",
  },
  {
    id: "single_room",
    label: "Single Room",
    src: "/img/listing-type/Single Room.png",
  },
];
...
const PropertyTypeRadio: React.FC<PropertyTypeRadioProps> = ({
  ...
  const [furnishedValidationError, setFurnishedValidationError] =
  ...
  return (
    <div style={{ textAlign: "center", padding: "20px" }}>
      ...
      <PropertyFurnishedCheckbox
        ...
        setFurnishedValidationError={setFurnishedValidationError}
      />
      {furnishedValidationError && (
        <p className="text-red-500 mt-2">
          Please select furnished/unfurnished to continue.
        </p>
      )}
