  ...
  <div className="flex justify-between">
    <div className="flex flex-col items-center mb-4">
      ...
      <Input
        ...
        min="0"
        value={
          typeof propertyDetails.roomCount === "number" ||
          typeof propertyDetails.roomCount === "string"
            ? propertyDetails.roomCount
            : ""
        }
        onChange={(e) =>
          setPropertyDetails({ ...propertyDetails, roomCount: e.target.value })
        }
    ...
    <div className="flex flex-col items-center mb-4">
      ...
      <Input
        ...
        min="0"
        value={
          typeof propertyDetails.bathroomCount === "number" ||
          typeof propertyDetails.bathroomCount === "string"
    ...
    <div className="flex flex-col items-center mb-4">
      ...
      <Input
        ...
        min="0"
        value={
          typeof propertyDetails.squareFootage === "number" ||
          typeof propertyDetails.squareFootage === "string"
