  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        <DualThumbSlider
          setShortestLeaseTerms={handleSetShortestLeaseTerms}
          setLongestLeaseTerms={handleSetLongestLeaseTerms}
          propertyDetails={propertyDetails}
      ...
      <div className="flex justify-evenly items-center ">
        <div className="scale-90">
          <CheckboxDemo
            ...
            isChecked={propertyDetails.requireBackgroundCheck}
            handleChange={() =>
              setPropertyDetails({
                ...propertyDetails,
                requireBackgroundCheck: !propertyDetails.requireBackgroundCheck,
              })
            }
            details={{ id: "requireBackgroundCheck" }}
          />
        </div>
