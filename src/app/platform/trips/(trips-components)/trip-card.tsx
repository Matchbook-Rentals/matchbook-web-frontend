              ...
              <PopoverContent className="w-fit p-1">
                <div className="flex flex-col w-full gap-1 text-left">
                  ...
                  <Dialog>
                    ...
                    <DialogContent className="max-w-4xl bg-gray-300 p-8 top-[25vh]" xOnRight={true}>
        ...
        <div className="flex flex-col items-start md:items-center gap-3 w-full md:w-auto">
          ...
          <div className="flex justify-center gap-2 w-full md:w-auto">
            ...
            <Dialog>
              ...
              <DialogContent className="max-w-4xl p-8 top-[25vh]" xOnRight={true}>
                <div className="mb-6">
                  <h2 className="text-2xl font-semibold">Edit Trip Details</h2>
                </div>
                <SearchEditBar tripId={trip.id} />
                ...
                <PopoverContent className="w-fit p-1">
                  <div className="flex flex-col w-full gap-1 text-left">
                    ...
                    <Dialog>
                      ...
                      <DialogContent className="max-w-4xl p-8 top-[15vh]" xOnRight={true}>
                        <div className="mb-6">
                          <h2 className="text-2xl font-semibold">Edit Trip Details</h2>
                        </div>
                        <SearchEditBar tripId={trip.id} />
