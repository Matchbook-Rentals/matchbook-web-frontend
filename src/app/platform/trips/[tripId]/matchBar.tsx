...
export default function MatchBar({
  ...
  return (
    <div
      onClick={handleLike}
      className="flex w-3/4 mx-auto border px-2 py-3 mt-3 border-black rounded-3xl "
    >
      ...
      <div
        onClick={setShowRankView}
        className="flex justify-between w-1/2 px-2 items-center border-gray-400"
      >
        <span>Cross Icon Placeholder</span>
        <div className="text-center text-lg font-semibold">
          <p>${currListing.price}/month</p>
          <p>
            {currListing.roomCount} bedroom / {currListing.bathroomCount}{" "}
            bathroom
          </p>
