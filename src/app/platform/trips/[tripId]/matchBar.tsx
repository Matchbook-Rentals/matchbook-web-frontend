...
export default function MatchBar({currListing, handleLike, setShowRankView}: {currListing: Listing, handleLike: Function}) {
  return (
    <div onClick={handleLike} className='flex w-3/4 mx-auto border px-2 py-3 mt-3 border-black rounded-3xl '>
      ...
      <div onClick={setShowRankView} className='flex justify-between w-1/2 px-2 items-center border-gray-400'>
