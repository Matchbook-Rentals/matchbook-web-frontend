  ...
  return (
    <div className="flex flex-col h-full bg-background">
      <div className="flex flex-1 overflow-hidden relative">
        <div
          className={`md:block h-ful bg-background ${isMobile ? 'absolute inset-0 transition-transform duration-300 w-full' : 'static w-1/3 min-w-[310px] max-w-[380px]'} ${isMobile && !sidebarVisible ? '-translate-x-full' : 'translate-x-0'}`}
        >
          <ConversationList
        ...
        <div
          className={`bg-background ${
            isMobile
              ? ' z-50 transition-transform duration-300 w-full'
              : 'static w-2/3 flex-1'
