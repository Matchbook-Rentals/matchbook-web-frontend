...
const MessageInputArea: React.FC<MessageInputAreaProps> = ({
  ...
  return (
    <div
      className={`${isMobile ? 'fixed bottom-0 left-0 right-0 z-30 bg-background transition-all duration-300' : 'relative pb-1 md:pl-4 bg-transparent'} overflow-x-hidden`}
      style={{
