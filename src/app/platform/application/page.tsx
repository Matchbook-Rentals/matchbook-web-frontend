...
import { upsertApplication, markComplete, getUserApplication } from '@/app/actions/applications';
...
export default function ApplicationPage() {
  ...
  useEffect(() => {
    ...
    const fetchUserApplication = async () => {
      ...
      try {
        ...
        if (application) {
          console.log('Fetched user application:', application);
  ...
  }, [initializeFromApplication, toast]);
