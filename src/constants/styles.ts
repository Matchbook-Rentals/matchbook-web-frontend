//constants/styles.ts
export const PAGE_MARGIN = 'w-full mx-auto md:w-[95vw] lg:w-[90vw] xl:w-[80vw] px-2 md:px-0';
...
export const TallDialogContent = 'sm:max-w-[536px] sm:h-[90vh] sm:m-0 p-0 flex flex-col font-montserrat';
export const TallDialogTitle = 'px-4 py-4 border-b border-gray-300 text-[20px] text-[#404040] text-center font-montserrat font-medium';
