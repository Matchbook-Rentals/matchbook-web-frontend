    ...
    <section className="flex justify-center  py-16">
      <div className="flex flex-col gap-[34px] w-full xl:max-w-[1140px] 2xl:max-w-[1400px]">
        <div className="gap-4 flex items-center flex-col md:flex-row">
          <h2 className="relative flex-1 mt-[-1.00px] [font-family:'Poppins',Helvetica] font-medium text-gray-neutral900 text-2xl md:text-[40px] tracking-[-2.00px] leading-[normal] text-center md:text-left">
