    ...
    <section className="flex flex-col items-center gap-14 py-16">
      <header className="flex flex-col items-center gap-6 w-full">
        ...
        <div className="flex flex-col items-center gap-4 w-full">
          ...
          <p className="w-[720px] font-text-label-medium-regular text-gray-neutral500 text-[16px] text-center">
      ...
      <div className="flex items-start gap-5 justify-center">
        <div className="flex flex-col w-[655px] items-start gap-5">
          ...
          <Card className="w-full h-[159px] rounded-xl overflow-hidden">
            <CardContent className="p-0">
        ...
        <Card className="w-[465px] h-[343px] rounded-xl overflow-hidden">
          <CardContent className="p-0">
            <img
