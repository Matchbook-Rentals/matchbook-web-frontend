...
export const LeaseSelectionDialog: React.FC<LeaseSelectionDialogProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent 
        className="flex flex-col items-center gap-6 p-6 bg-white w-full max-w-[calc(100%-2rem)] sm:max-w-2xl md:max-w-4xl mx-auto !top-[25vh] translate-y-0"
