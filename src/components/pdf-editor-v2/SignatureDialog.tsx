...
export const SignatureDialog: React.FC<SignatureDialogProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-[95vw] sm:max-w-2xl max-h-[85dvh] sm:max-h-[90vh] overflow-y-auto p-3 sm:p-6 !top-[10vh] sm:!top-[15vh] sm:!translate-y-0" showCloseButton={false}>
        <h2 className="text-center text-base sm:text-lg font-semibold">Add Your Signature</h2>
