...
import { useStepCompletion } from '@/hooks/useStepCompletion-v2';

// Service layer functions
import { saveTemplateAndCreateDocument as saveTemplateService, loadTemplate as loadTemplateService } from '@/services/templateService-v2';
import { saveDocumentAndStartSigning as saveDocumentAndStartSigningService, loadDocumentForSigning as loadDocumentForSigningService, createDocumentAndStartSigning as createDocumentAndStartSigningService, saveDocument as saveDocumentService } from '@/services/documentService-v2';
import { saveSignerProgressAsync as saveSignerProgressAsyncService, saveSignerProgressAndContinue as saveSignerProgressAndContinueService } from '@/services/signingService-v2';

// Utility functions
import { getFieldLabel } from '@/utils/fieldLabelUtils-v2';
import { getUnsignedFields as getUnsignedFieldsUtil } from '@/utils/fieldFilterUtils-v2';
import { navigateToField as navigateToFieldUtil, navigateToNextField as navigateToNextFieldUtil } from '@/utils/fieldNavigationUtils-v2';

// New workflow system
import { useWorkflowStateMachine } from '@/features/lease-signing-v2/hooks/useWorkflowStateMachine';
import { WorkflowPhase, WorkflowState as NewWorkflowState } from '@/features/lease-signing-v2/types/workflow.types';
import { legacyStateToPhase, phaseToLegacyState, createWorkflowStateFromLegacy, getSignerIndexFromLegacy } from '@/features/lease-signing-v2/adapters/workflowAdapter';
import {
  isEditablePhase,
  ...
  getSignerLabel
} from '@/features/lease-signing-v2/utils/workflowHelpers';
import {
  calculateFieldProgress,
  getIncompleteFields,
  areAllSignerFieldsComplete,
  isSigningField
} from '@/features/lease-signing-v2/utils/fieldDecomposition';
