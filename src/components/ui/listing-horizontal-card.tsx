...
export default function ListingHorizontalCard({
  imgSrc,
  title,
  status,
  address,
}: ListingHorizontalCardProps) {
  return (
    <div className="flex max-w-[675px] max-h-[135px] border-2 border-gray-300 rounded-md overflow-hidden">
      ...
      <div className="flex flex-col justify-center p-4 w-1/2">
        ...
        <div className="mt-4 flex justify-end">
          <Badge className="bg-primaryBrand text-black text-md font-bold rounded-none hover:bg-primaryBrand px-2 py-1">
            {status.toUpperCase()}
          </Badge>
        </div>
      </div>
