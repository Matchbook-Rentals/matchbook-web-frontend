...
export const CancellationPolicySection: React.FC = () => {
  return (
    <Card className="flex-col items-start gap-5 self-stretch w-full flex-[0_0_auto] flex relative border-0 shadow-none">
      <CardContent className="flex-col items-start gap-2 self-stretch w-full flex-[0_0_auto] flex relative p-0">
        ...
        <div className="relative self-stretch font-poppins font-normal text-[#333333] text-base tracking-[0] leading-[28.8px]">
